...
export const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  PASSWORD_TOO_SHORT: "A senha deve ter no mínimo 12 caracteres",
  ...
  VERIFICATION_EMAIL_NOT_ENABLED: "A verificação de e-mail não está habilitada",
  ...
  RESET_PASSWORD_DISABLED: "A redefinição de senha não está habilitada",
  ...
  FAILED_TO_UNLINK_LAST_ACCOUNT:
    "Você precisa manter pelo menos um método de acesso",
  PASSWORD_ALREADY_SET: "Esta conta já possui uma senha definida",
  CREDENTIAL_ACCOUNT_NOT_FOUND: "Esta conta ainda não possui senha definida",
  LINKING_NOT_ALLOWED:
    "O e-mail do provedor deve ser igual ao e-mail principal da conta",
  CHANGE_EMAIL_IS_DISABLED: "A troca de e-mail não está habilitada",
  EMAIL_IS_THE_SAME: "O novo e-mail deve ser diferente do atual",
}
